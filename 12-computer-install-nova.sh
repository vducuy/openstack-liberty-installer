...
crudini --set /etc/nova/nova.conf DEFAULT my_ip ${COMPUTE_ADDR}
...
crudini --set /etc/nova/nova.conf vnc my_ip ${COMPUTE_ADDR}
crudini --set /etc/nova/nova.conf vnc vncserver_listen 0.0.0.0
crudini --set /etc/nova/nova.conf vnc vncserver_proxyclient_address ${COMPUTE_ADDR}
